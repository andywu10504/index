const aboutProfile = {
  ...
  awards: [
    ...
    lifeJourney: [
      { year: 1989, title: "出生", score: 0, desc: "1989年09月26日於高雄出生。", category: "life" },
      { year: 1990, title: "求道", score: 2, desc: "1990年04月10日於林氏佛堂求道。", category: "faith" },
      { year: 2004, title: "就讀大榮中學電子科", score: 1, desc: "不知道要讀什麼就選擇大榮高中電子科，至少不是這麼討厭。", category: "education" },
      { year: 2005, title: "立愿", score: 1, desc: "立下「戒除菸酒賭」、「辦事員」、「逢期必至」、「花齋」等愿力。", category: "faith" },
      { year: 2005, title: "首次辦理少年營", score: 3, desc: "高雄地區兒童營停辦多年，幾個同修聚集，首次辦理兒童營。", category: "faith" },
      { year: 2005, title: "擔任大隊長", score: 3, desc: "", category: "scout" },
      { year: 2007, title: "意外考上金門技術學院", score: 3, desc: "當時有陸軍專科學校、高雄正修科技大學與國立金門技術學院可以選擇，最終選擇了國立金門技術學院，就開啟了長達4年的大學生活。", category: "education" },
      { year: 2007, title: "受南極仙翁點化", score: 2, desc: "當時候受朋友邀請，參加了別支組線的法會，南極仙翁臨壇，跟我說：「要吃素喔」，我也搞不懂為什麼。", category: "faith" },
      { year: 2009, title: "擔任羅浮群群長", score: 3, desc: "因為社團大四學長要準備畢業，必須找人交接，當時的我只有參加過幾次社團活動，對童軍運動並沒有經驗，只能硬著頭皮接下。", category: "scout" },
      { year: 2009, title: "辦理幾次活動開始有新生加入", score: 2, desc: "接下群長的我，剛好一個同班同學，一個有經驗，就成為浮木，從他身上先學習一些童軍知能，因為不怕生的關係，也從系上找到幾個學弟，願意加入，並且協助辦理幾次活動。", category: "scout" },
      { year: 2010, title: "初戀", score: 3, desc: "在一次偶然的活動機會下，認識當時的女朋友，就開始了第一次戀愛。", category: "life" },
      { year: 2010, title: "信任危機", score: -2, desc: "因為脾氣不好又焦慮，容易對女朋友發脾氣，更在那時候經歷了身邊的一些重大事件。", category: "life" },
      { year: 2011, title: "第一次失戀", score: -3, desc: "", category: "life" },
      { year: 2011, title: "獲金門縣好人好事代表", score: 2, desc: "", category: "scout" },
      { year: 2011, title: "學習吃素", score: 1, desc: "一個吃素可以改變運氣的念頭，讓我從那年就開始吃素。", category: "faith" },
      { year: 2012, title: "延畢", score: -2, desc: "因為學分不足而延畢。", category: "education" },
      { year: 2013, title: "大學畢業", score: 2, desc: "終於在多重方式下，完成大學學業。", category: "education" },
      { year: 2013, title: "服役於海軍陸戰隊", score: 1, desc: "抽中海軍陸戰隊，為期一年的兵役。", category: "military" },
      { year: 2013, title: "初次瞭解吃素的難度", score: 2, desc: "隊上有一個吃素的同袍，家裡只有他一個人吃素，在家吃得非常辛苦。", category: "faith" },
      { year: 2013, title: "第二次失戀", score: -2, desc: "當兵期間，跟第二任女朋友分手。", category: "life" },
      { year: 2014, title: "日月光任職", score: 2, desc: "退伍後第一個工作在華碩旗下的外包維修廠商擔任工程師，同時間也投履歷至日月光半導體，工作一個月後，旋即至日月光任職。", category: "work" },
      { year: 2014, title: "輪班轉正常班", score: 3, desc: "因為某些因素，從輪班轉往正常班，雖然錢領得比較少，但有更多的時間可以配合幫辦。", category: "work" },
      { year: 2014, title: "擔任高雄青年班活動組長", score: 3, desc: "在大學期間有許多活動經驗，在點傳師慈悲，接下高雄青年班活動組長的任務。", category: "faith" },
      { year: 2015, title: "首次擔任國學營活動組長", score: 3, desc: "首次擔任國學營活動組長工作，並於活動中設計實境解謎與搶答活動，獲得熱烈好評。", category: "faith" },
      { year: 2015, title: "十年一刻", score: 2, desc: "少年營籌辦滿10年。", category: "faith" },
      { year: 2016, title: "受總統接見優秀童軍", score: 3, desc: "", category: "scout" },
      { year: 2016, title: "考上高師大碩士學程", score: 3, desc: "對當老師有憧憬，因此選擇國立高雄師範大學軟體工程學系。", category: "education" },
      { year: 2017, title: "考上師培學程沒有去讀", score: -1, desc: "考上碩士後隔年考上師培學程，但因為多方考量即作罷。", category: "education" },
      { year: 2018, title: "諾羅病毒", score: -2, desc: "", category: "life" },
      { year: 2019, title: "移除唾液腺腫瘤", score: -1, desc: "四月份發現左臉頰下方有硬塊，五月份醫生就建議割除。", category: "life" },
      { year: 2019, title: "第二次擔任國學營活動組長", score: 3, desc: "因為有前一次的完美經驗，也給自己特別大的壓力，完成了用一連串的故事主軸與Line@完成的實境解謎。", category: "faith" },
      { year: 2019, title: "高雄車禍", score: -2, desc: "開車被酒駕車禍撞上，了解生命無常。", category: "life" },
      { year: 2019, title: "立愿清口茹素", score: 2, desc: "", category: "faith" },
      { year: 2021, title: "碩士畢業", score: 3, desc: "", category: "education" }
    ]
};
